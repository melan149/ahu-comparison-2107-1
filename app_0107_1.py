...
sens_efficiency_nominal_col = get_column_safe(df, ["Sens. efficiency at nominal balanced airflows [%]", "Sens. efficiency at nominal balanced airflows"])
sens_efficiency_opt_col = get_column_safe(df, ["Sens. efficiency at opt balanced airflows (ErP) [%]", "Sens. efficiency at opt balanced airflows (ErP)"])
...
header_triggers_raw = {
    ...
    sens_efficiency_nominal_col: "PCR/HEX recovery exchanger", # First occurrence
    sens_efficiency_opt_col: "Fan section data", # Second occurrence
    impeller_efficiency_col: "Electrical heater",
