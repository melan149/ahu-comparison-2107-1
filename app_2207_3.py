...
with st.sidebar:
    st.header("Select Units for Comparison") # Title for the sidebar filter section
...
brand1_logo_path_raw = df_filtered_by_brand1[logo_col].iloc[0] if not df_filtered_by_brand1.empty and logo_col else None
...
loaded_image2 = None
# Retrieve the path and convert to string, or None if NaN/empty
brand2_logo_path_raw = df_filtered_by_brand2[logo_col].iloc[0] if not df_filtered_by_brand2.empty and logo_col else None
...
# Retrieve the path and convert to string, or None if NaN/empty
unit_photo_path1_raw = df_filtered_by_unit1[unit_photo_col].values[0] if not df_filtered_by_unit1.empty and unit_photo_col and unit_photo_col in df_filtered_by_unit1.columns else None
...
# Retrieve the path and convert to string, or None if NaN/empty
unit_photo_path2_raw = df_filtered_by_unit2[unit_photo_col].values[0] if not df_filtered_by_unit2.empty and unit_photo_col and unit_photo_col in df_filtered_by_unit2.columns else None
